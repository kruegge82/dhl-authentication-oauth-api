...
/**
 * GetSemanticVersion200ResponseAmp Class Doc Comment
 *
 * @package  kruegge82\DHLAuth
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetSemanticVersion200ResponseAmp implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getSemanticVersion_200_response_amp';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['version']) && !preg_match("/^v\\d{1,2}\\.\\d{1,2}(\\.\\d{1,2}){0,1}$/", $this->container['version'])) {
            $invalidProperties[] = "invalid value for 'version', must be conform to the pattern /^v\\d{1,2}\\.\\d{1,2}(\\.\\d{1,2}){0,1}$/.";
        }
    ...
    public function setVersion(?string $version): static
    {
        ...
        if ((!preg_match("/^v\\d{1,2}\\.\\d{1,2}(\\.\\d{1,2}){0,1}$/", ObjectSerializer::toString($version)))) {
            throw new InvalidArgumentException("invalid value for \$version when calling GetSemanticVersion200ResponseAmp., must conform to the pattern /^v\\d{1,2}\\.\\d{1,2}(\\.\\d{1,2}){0,1}$/.");
        }
