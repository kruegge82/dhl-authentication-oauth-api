...
class TokenResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['access_token']) && (mb_strlen($this->container['access_token']) > 50)) {
            $invalidProperties[] = "invalid value for 'access_token', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['token_type']) && (mb_strlen($this->container['token_type']) > 20)) {
            $invalidProperties[] = "invalid value for 'token_type', the character length must be smaller than or equal to 20.";
        }
    ...
    public function setAccessToken(?string $access_token): static
    {
        ...
        if ((mb_strlen($access_token) > 50)) {
            throw new InvalidArgumentException('invalid length for $access_token when calling TokenResponse., must be smaller than or equal to 50.');
        }
     ...
     * Sets token_type
     *
     * @param string|null $token_type Will be set to 'Bearer'
     *
     * @return $this
     */
    public function setTokenType(?string $token_type): static
    {
        ...
        if ((mb_strlen($token_type) > 20)) {
            throw new InvalidArgumentException('invalid length for $token_type when calling TokenResponse., must be smaller than or equal to 20.');
        }
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Seconds
     *
     * @return $this
     */
